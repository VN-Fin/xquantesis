...
import websocket
from xquantesis.config import settings
from xquantesis.data.datasources import BaseDataSource
from xquantesis.protoc.websocket_message_pb2 import StockOHLCVMessage
import base64
